#se usa en el ambiente de ciencia de datos, porque la informacion ya esta clasificada o separada de cierta manera o cierto orden 
#este formato tambien es usado en ciertas bases de datos pequeñas
